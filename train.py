...
class LitModel(pl.LightningModule):
    def __init__(self, model=None, loss_type='regression_mse_var', similarity_type='l2', temperature=0.1, variance_lambda=0.001, use_random_window=False, use_center_window=False, window_size=5, use_align_alpha=False, align_alpha_strength=0.1, do_not_reduce_frame_rate=False, small_embedder=False, dont_stack=False, schedule_window=False):
        super().__init__()
        ...
        self.model = model if model else ModelWrapper(do_not_reduce_frame_rate=self.do_not_reduce_frame_rate, small_embedder=self.small_embedder, dont_stack=self.dont_stack)
